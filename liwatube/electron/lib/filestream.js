'use strict';
/**
 * LiwaTube — خدمة الملفات المحلية عبر بروتوكول liwa:// مع دعم Range (ضروري لتقديم/تأخير الفيديو).
...
const MIME = {
  ...
  '.mkv': 'video/x-matroska', '.ogv': 'video/ogg', '.ogg': 'video/ogg', '.avi': 'video/x-msvideo',
